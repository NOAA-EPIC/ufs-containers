...
echo $bindstring
sed -i "s|BINDDIRS|$bindstring|g" $exec_dir/run_container_executable.sh
sed -i "s|LDLIB_PATH|$LD_LIBRARY_PATH|g" $exec_dir/run_container_executable.sh
sed -i "s|LIB_PATH|$LIBRARY_PATH|g" $exec_dir/run_container_executable.sh
sed -i "s|FI_PATH|$FI_PROVIDER_PATH|g" $exec_dir/run_container_executable.sh
...
chmod +x $exec_dir/*
rm $exec_dir/run_container_executable.sh
